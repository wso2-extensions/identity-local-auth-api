...
/**
 * This class defines the operations provided for authentication.
 */
public interface AuthManager {

    /**
     * Authenticates the user over the authentication request initiated.
     *
     * @param request Authentication request
     * @return Authentication response
     * @throws AuthAPIException throws upon request validation or server error.
     */
    public AuthnResponse authenticate(AuthnRequest request) throws AuthAPIException;

    /**
     * Generates the auth token for the authenticated subject.
     *
     * @param context authentication message context
     * @throws AuthAPIException throws upon request validation or server error.
     */
