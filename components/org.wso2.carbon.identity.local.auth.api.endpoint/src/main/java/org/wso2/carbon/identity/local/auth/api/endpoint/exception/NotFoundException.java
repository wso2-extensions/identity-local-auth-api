...
/**
 * This exception represents a error upon a resource not found.
 */
public class NotFoundException extends ClientErrorException {

    public NotFoundException(ErrorDTO errorDTO) {

        super(Response.status(Response.Status.NOT_FOUND).entity(errorDTO).header(AuthEndpointConstants
